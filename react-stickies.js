	...
	**/
	...
	var _class = function (_Component) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function handleCategoryChange(html, currentNote) {
	      var _this2 = this;

	      var notes = this.state.notes;
	      notes.forEach(function (note) {
	        if (currentNote.id === note.id) {
	          note.category = html.target.value;
	        }
	      });
	      this.setState({
	        notes: notes
	      }, function () {
	        if (_this2.props.onCategoryChange) {
	          _this2.props.onCategoryChange(html, currentNote);
	        }
	      });
	    }
	  }, {
	    ...
	    value: function onChange(editorState, currentNote) {
	      ...
	      if (typeof this.props.onChange === 'function') {
	        this.props.onChange(transformContentState(this.state.notes), 'update',currentNote);
	      }
	    }
	  }, {
	    key: 'deleteNote',
	    ...
	    value: function renderNote(note) {
	      ...
	      return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_ContentEditable2.default, {
						html: note.category,
						onChange: function onChange(html) {
						  return _this5.handleCategoryChange(html, note);
						}
					  })				  )
			  )
			//   ),
	        ...
	        //     //     }
			// 	//   })
			// 	_react2.default.createElement("select", { className: 'title', style: noteTitleStyle },
			// 	_react2.default.createElement("option", {value: "A"}, "Option A"),
			// 	_react2.default.createElement("option", {value: "B"}, "Option B"),
			// 	_react2.default.createElement("option", {value: "C"}, "Option C")
    		// 	)
	        //     )
